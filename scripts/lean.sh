...
# ax模式下重启机器会卡内核
#svn export https://github.com/gngpp/lede/trunk/package/kernel/mac80211 package/kernel/mac80211
#svn export https://github.com/gngpp/lede/trunk/package/kernel/mt76 package/kernel/mt76
